...
class ParamCardWriter(object):
    ...
    def __init__(self, filename, list_of_parameters=None, generic=False):
        ...
        if not list_of_parameters:
            ...
            list_of_parameters = [
                param for param in all_parameters if param.nature == "external"
            ]
    ...
    def define_not_dep_param(self, list_of_parameters):
        ...
        self.dep_mass = [
            ...
            if part.pdg_code > 0 and part.mass not in list_of_parameters
        ]
        self.dep_width = [
            (part, part.width)
            for part in all_particles
            if part.pdg_code > 0 and part.width not in list_of_parameters
        ]
    ...
    def write_card(self, all_ext_param):
        ...
        for lhablock in all_lhablock:
            ...
            need_writing = [
                param for param in all_ext_param if param.lhablock == lhablock
            ]
